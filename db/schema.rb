...
ActiveRecord::Schema.define(version: 20150831154254) do
  ...
  add_index "follows", ["espace_id"], name: "index_follows_on_espace_id", using: :btree
  ...
  add_index "likes", ["art_piece_id"], name: "index_likes_on_art_piece_id", using: :btree
